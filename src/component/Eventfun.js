    ...
    return (
        <div>
           ...
           <div className='numnmlogo'>
                ...
                <span className='partylogo'><img className='aapimglogo' src={require('../component/imgs/aap.png')} alt=''/></span>
           </div>
           <div className='lightbtn'>
           ...
           <div className='numnmlogo'>
                ...
                <span className='partylogo'><img  className='bspimglogo' src={require('../component/imgs/bsp.png')} alt=''/></span>
           </div>
           <div className='lightbtn'>
           ...
           <div className='numnmlogo'>
                ...
                <span className='partylogo'><img className='nppimglogo' src={require('../component/imgs/npp.svg.png')} alt=''/></span>
           </div>
           <div className='lightbtn'>
